...
// 40 écrans, identique sur PC et mobile — même rythme de scroll partout.
const SCROLL_SPACE_MULTIPLIER = 40;
// Exposé sur window pour que scene3d.js l'utilise aussi au recalcul (rotation).
window.SCROLL_SPACE_MULTIPLIER = SCROLL_SPACE_MULTIPLIER;
